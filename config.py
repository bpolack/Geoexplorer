...
config={
   ...
   'SCANNING_AREA' : (49.261755, -122.12677, 49.023236, -121.714783),                # Big area

   # Scanning box options
   'box':
   {
      'X_DISTANCE' : 10000,   # desirable width of box in m.
      'Y_DISTANCE' : 10000,   # desirable height of box in m.
